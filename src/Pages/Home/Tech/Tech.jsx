...
import techData from "../../../Json/TeachData.json";
...
const Tech = () => {
  ...
  return (
    <div className="p-6 2xl:p-20 md:px-40 py-20 ">
      <h2 className="text-2xl md:text-4xl font-bold mb-6 text-center text-gray-200">
        Our Tech Stack
      </h2>
          ...
          <span
            ...
            className={`cursor-pointer text-base md:text-lg lg:text-2xl font-semibold transition duration-300 p-2 rounded-lg transform hover:scale-95 ${
              selectedTech === tech
                ...
                : "text-gray-100 hover:text-green-600 hover:border hover:border-green-600"
            }`}
      ...
      <div className="flex flex-wrap justify-center gap-8 md:gap-x-20 2xl:gap-x-44 gap-y-10  mt-10">
        {techData[selectedTech].map((item) => (
          <div key={item.name} className="flex flex-col items-center">
            ...
            <h3 className="text-sm md:text-lg font-semibold mt-2 text-center text-gray-200">
              {item.name}
            </h3>
          </div>
        ))}
