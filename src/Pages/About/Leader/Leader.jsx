import leaders from "../../../Json/Leader.json";

const Leader = () => {
  return (
    <>
      <div className="my-20 md:my-60">
        <h2 className="text-4xl font-bold mb-3 text-center text-gray-200">
          Meet Our Leaders
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 md:px-10">
          {leaders.map((leader, index) => (
            ...
            >
              ...
              <p className="text-base text-gray-400">{leader.position}</p>
